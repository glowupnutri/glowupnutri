...
import InPostMap from "@modules/checkout/components/inpost-map"
...
const Shipping: React.FC<ShippingProps> = ({
  ...
  // Detect if InPost option is currently selected
  const isInPostSelected = _shippingMethods?.some(
    (sm) =>
      sm.id === shippingMethodId &&
      (sm.name?.toLowerCase().includes("inpost") ||
        sm.name?.toLowerCase().includes("paczkomat"))
  )

  const handleInPostPointSelect = useCallback((point: any) => {
          ...
          <div className="grid">
            <div className="flex flex-col">
              ...
              <span className="mb-4 text-ui-fg-muted txt-medium">
                Wybierz sposób dostarczenia zamówienia
              </span>
            </div>
            <div data-testid="delivery-options-container">
              <div className="pb-8 md:pt-0 pt-2">
                ...
                {/* InPost GeoWidget Map — show when InPost option is selected */}
                {isInPostSelected && (
                  <div className="mt-2 mb-4">
                    ...
                    <InPostMap
                      onPointSelect={handleInPostPointSelect}
              ...
              <div className="flex flex-col w-1/3">
                ...
                {selectedInPostPoint && (
                  <Text className="txt-small text-ui-fg-muted mt-1">
                    📍 Paczkomat: {selectedInPostPoint.name}
                  </Text>
                )}
              </div>
            )}
